...
export default function HomeContent() {
  ...
  const stats = [
    { value: "21+", label: "Years of Excellence", desc: "Industry Leadership" },
  ...
  const services = [
    {
      ...
      description:
        "Rigorous testing protocols and ISO-certified quality control processes ensure every batch meets international standards.",
    ...
    },
    {
      ...
      description:
        "State-of-the-art supply chain management with real-time tracking, temperature-controlled transport, and timely delivery.",
    ...
    },
    {
      ...
      description:
        "Expert consultation from our team of chemists and engineers for product selection, application, and troubleshooting.",
    ...
    },
    {
      ...
      description:
        "Environmentally responsible sourcing and distribution with carbon-neutral shipping options and eco-friendly packaging.",
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-semibold text-blue-600">
                  Trusted Chemical Partner Since 2005
                </span>
              </div>
              ...
              <p className="text-base sm:text-lg lg:text-xl text-slate-600 leading-relaxed max-w-xl">
                Al-Ibrahim Group of Companies delivers world-class chemical
                products and cutting-edge Universe LED lighting solutions with
                uncompromising quality standards. Your trusted partner for
                industrial and lighting excellence across Pakistan and beyond.
              </p>
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center space-x-5">
                  <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center shadow-xl shadow-green-500/30">
                    <svg
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-6xl font-black text-slate-900 leading-tight">
                Pioneering Innovation in Chemical & LED Industry
              </h2>
              ...
              <div className="flex flex-wrap gap-4 pt-6">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center space-x-3 px-6 py-3 bg-white rounded-xl border border-slate-200 shadow-md hover:shadow-xl hover:border-blue-300 transition-all duration-300"
                  >
            ...
            <div className="relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-slate-300/50 border-4 border-white transform hover:scale-105 transition-all duration-700">
                <div className="relative w-full h-[650px] bg-gradient-to-br from-[#f7f7f7] to-[#f7f7f7]">
                  <img
        ...
        <div className="container mx-auto px-8 lg:px-16">
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-slate-600 font-medium">
              Over a decade of consistent growth, unwavering quality, and client
              satisfaction
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${stat.color} opacity-0 group-hover:opacity-[0.03] transition-opacity duration-500`}
                ></div>

                {/* Top Accent Line */}
                <div
                  className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${stat.color} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}
                ></div>
                ...
                <div className="relative z-10">
                  ...
                  {/* Value */}
                  <div
                    className={`text-5xl lg:text-6xl font-black bg-gradient-to-br ${stat.color} bg-clip-text text-transparent mb-3 tracking-tight`}
                  >
                    {stat.value}
                  </div>
      ...
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="container mx-auto px-8 lg:px-16">
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-slate-600 font-medium">
              From sourcing to delivery, we handle every aspect of your chemical
              supply needs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${service.color} rounded-2xl text-white mb-6 shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}
                  >
                    {service.icon}
                  </div>
        ...
        <div className="container mx-auto px-8 lg:px-16 relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-sm sm:text-lg lg:text-xl text-slate-300 font-medium">
              Our extensive distribution network ensures reliable products
              ...
              <div className="flex items-center space-x-3 sm:space-x-4 mb-6 sm:mb-8 lg:mb-10">
                <div className="relative">
                  ...
                  <div className="relative w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-600 to-blue-500 rounded-2xl sm:rounded-3xl flex items-center justify-center shadow-2xl shadow-blue-500/30">
                    <svg
                      className="w-6 h-6 sm:w-7 sm:h-7 lg:w-9 lg:h-9 text-white"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <div>
                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-white mb-1">
                    Domestic Network
                  </h3>
                  <p className="text-xs sm:text-sm lg:text-base text-blue-300 font-semibold">
                ...
                {cities.map((city, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm sm:text-base lg:text-lg text-slate-200 font-bold group-hover/item:text-white transition-colors truncate">
                        {city}
                      </span>
                    </div>
                  </div>
            ...
            <div className="relative z-10 px-4 sm:px-6 lg:px-16 py-12 sm:py-16 lg:py-24">
              <div className="max-w-5xl mx-auto text-center">
                ...
                <p className="text-sm sm:text-lg lg:text-2xl text-blue-50 mb-10 sm:mb-12 lg:mb-16 leading-relaxed max-w-4xl mx-auto font-medium">
                  At Al-Ibrahim Group, every client relationship is built on
                  trust, transparency, and exceptional service. We don't just
                  deliver products—we deliver peace of mind, reliability, and
                  partnership that drives your success forward.
                </p>
                ...
                <div className="grid md:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-12 lg:mb-16">
                  {[
                    ...
                    <div
                      key={i}
                      className="group bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-500 transform hover:-translate-y-2"
                    >
                      ...
                      <div className="text-base sm:text-lg lg:text-xl font-black text-white mb-2 sm:mb-3">
                        {item.title}
                      </div>
                ...
                <div className="inline-block bg-white rounded-2xl sm:rounded-[2.5rem] px-6 sm:px-10 lg:px-16 py-8 sm:py-10 lg:py-12 shadow-2xl shadow-blue-900/30 transform hover:scale-105 transition-all duration-500">
                  ...
                  <div className="text-lg sm:text-2xl lg:text-3xl font-black text-slate-900 mb-2">
                    Customer Satisfaction
                  </div>
                  <div className="relative z-10 px-4 sm:px-6 lg:px-16 py-12 sm:py-16 lg:py-6">
                    Based on 500+ client feedback surveys and retention metrics
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-12 items-center p-6 sm:p-8 lg:p-16">
              <div className="lg:col-span-3 space-y-8">
                ...
                <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-600 leading-relaxed">
                  Join hundreds of satisfied clients who trust Al-Ibrahim Group
                  for their products supply needs. Let's discuss how our
                  comprehensive solutions can drive your business forward.
                </p>
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-xl flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                        {item.icon}
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-sm sm:text-base text-slate-900 font-bold break-words">
                          {item.value}
                        </div>
                      </div>
                    </div>
