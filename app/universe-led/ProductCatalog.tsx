...
//   {
//     rowTitle: 'NIN BULBS',
//     categoryTitle: 'SUPREME SERIES & NIN BULBS',
//     products: [
//       {
//         id: 'bulb-50w',
//         name: 'BULB (50 Watts)',
...
//   {
//     rowTitle: 'ARSCON / COB',
//     categoryTitle: 'ARSCON SERIES & COB',
//     products: [
//       {
//         id: 'ice-panel-12w',
//         name: 'ICE PANEL (12 W)',
...
//           <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-slate-900 mb-6 leading-tight">
//             Our Products
//           </h2>
//           <p className="mt-3 text-slate-600 text-sm md:text-base">
//             Premium LED lighting range for residential, commercial and industrial use.
//           </p>
//         </div>
...
//           {productRows.map((row) => (
//             <div key={row.rowTitle + row.categoryTitle}>
//               {/* Row header: SUPREME + category on same line */}
//               <div className="flex items-center gap-4 mb-6">
//                 <span className="inline-flex items-center rounded-full bg-emerald-500 px-4 py-1 text-xs md:text-sm font-semibold uppercase tracking-[0.2em] text-white">
//                   SUPREME
//                 </span>
//                 <div className="h-px flex-1 bg-emerald-500/40" />
//                 <span className="text-sm md:text-base font-semibold text-emerald-300 uppercase tracking-wide">
//                   {row.categoryTitle}
//                 </span>
//               </div>
...
//   return (
//     <article className="flex flex-col h-full rounded border border-slate-700 bg-slate-900/80 shadow-md shadow-slate-950/40 transition-transform duration-200 hover:-translate-y-1">
//       {/* Image */}
...
//         )}
//         {product.rate && (
//           <div className="absolute top-3 right-3 rounded-md bg-red-600 px-3 py-1 text-xs font-bold text-white">
//             RATE {product.rate}
//           </div>
//         )}
//       </div>
...
//   {product.carton && (
//     <p className="text-xs md:text-sm text-slate-600">
//       <span className="font-semibold text-slate-900">Carton:</span>{' '}
//       {product.carton}
//     </p>
//   )}
