  ...
  const products = [
    {
      ...
      power: "6W - 48W",
      description:
        "Ultra-slim LED panels for modern ceiling installations with uniform light distribution",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      power: "3W - 20W",
      description:
        "Energy-efficient LED bulbs in various shapes and sizes for residential and commercial use",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      power: "9W - 24W",
      description:
        "High-efficiency LED tubes as perfect replacements for traditional fluorescent lighting",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      power: "5W - 30W",
      description:
        "Recessed LED downlights providing focused illumination for ceilings and architectural spaces",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      power: "12V - 24V",
      description:
        "Flexible LED strips for decorative lighting, accent lighting, and creative installations",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      power: "20W - 200W",
      description:
        "High-power LED floodlights for outdoor illumination, security, and stadium lighting",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      power: "7W - 15W",
      description:
        "WiFi-enabled smart LED lights with app control, dimming, and color-changing capabilities",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      power: "1W - 10W",
      description:
        "Artistic and decorative LED fixtures for ambient lighting and interior design applications",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
  ...
  const features = [
    {
      ...
      description:
        "Up to 80% energy savings compared to traditional lighting solutions",
      icon: "⚡",
    },
    {
      title: "Long Lifespan",
      description:
        "50,000+ hours operational life with minimal maintenance requirements",
      icon: "🔋",
    },
    {
      title: "Eco-Friendly",
      description:
        "Mercury-free, low heat emission, and fully recyclable components",
      icon: "♻️",
    },
    {
      title: "Superior Quality",
      description:
        "Premium-grade LEDs with consistent color temperature and brightness",
      icon: "✨",
    },
  ];
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <span className="text-sm font-semibold text-blue-600">
                  Universe LED - Premium Lighting Solutions
                </span>
              </div>
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed max-w-xl">
                Universe LED, another key venture of the group, specializes in
                the import and supply of LED products, providing a wide range of
                modern and energy-efficient LED solutions. The company is
                committed to delivering innovative lighting products that
                combine performance, durability, and sustainability. By keeping
                pace with evolving technology and market trends, Universe LED
                aims to support energy conservation while offering reliable
                lighting solutions for residential, commercial, and industrial
                applications.
              </p>
        ...
        <div className="container mx-auto px-8 lg:px-16">
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 font-medium">
              All our LED products undergo rigorous quality control and testing
              procedures
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="text-xl sm:text-2xl font-black text-slate-900 mb-4">
                    {feature.title}
                  </div>
        ...
        <div className="container mx-auto px-8 lg:px-16 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-50 mb-16 leading-relaxed max-w-4xl mx-auto font-medium">
              We use the latest technology to guarantee superior performance,
              durability, and energy efficiency. All products come with extended
              warranties and have lifecycles measured in years, not months.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-500"
                >
                  <div className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-3">
                    {stat.value}
                  </div>
                  <div className="text-base sm:text-lg md:text-xl font-bold text-blue-50">
                    {stat.label}
                  </div>
                </div>
              ))}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center p-12 lg:p-16">
              <div className="space-y-8">
                ...
                <p className="text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed">
                  Contact us today for customized LED solutions and expert
                  consultation. Our team is ready to help you find the perfect
